  ...
  <footer className="bg-navy py-16">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="flex items-center justify-center gap-4 mb-8">
        <a
          href="https://instagram.com/affinitycor"
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full border border-silver/20 flex items-center justify-center text-silver/60 hover:text-primary hover:border-primary transition-all"
