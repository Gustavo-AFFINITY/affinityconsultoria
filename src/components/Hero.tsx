      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="max-w-3xl">
          ...
          <ScrollReveal delay={0.15}>
            <p className="text-silver text-base sm:text-lg md:text-xl leading-relaxed mt-4 mb-8 md:mb-10 max-w-2xl text-neutral-300 md:mr-[200px] ml-0 pl-0 pr-0 text-left mr-[140px]">
